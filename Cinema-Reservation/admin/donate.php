...
<body>
    ...
    <div class="container mt-5 mb-5 d-flex justify-content-center">
        ...
        <form class=""  action=" " method="POST">
            <div class="card-body">
                <h2 class="card-title mb-3">Food Donate</h2>
                
                <h6 class="information mt-4">Please Enter the Quantity You wanna Donate</h6>
                <div class="row">
                    <div class="col-sm-12">
...
if(isset($_POST['submit']))
{
    ...
    $sql = "INSERT INTO donate (Pizza, Burger, Noodles, Shezwanrice, Samosachat, order_date) VALUES (?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssssss", $pizaa, $burger, $noddle, $shezwan, $samosa, $order_date);

    if ($stmt->execute() === TRUE) 
    {
        // echo "Data inserted successfully";
        header("Location: http://localhost/titans/Cinema-Reservation/admin/admin.php");
        exit;
    } 
    else 
    {
